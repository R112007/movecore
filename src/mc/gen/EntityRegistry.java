...
public final class EntityRegistry {
    ...
    public static <T, E extends Entityc> T content(String name, Class<E> type,
        ...
        if (type.getName().startsWith("mindustry.gen.")) {
            ...
            EntityMapping.nameMap.put("mcore-" + name, prov);
        } else {
            EntityMapping.nameMap.put("mcore-" + name, get(type));
        }
    ...
    public static void register() {
        register("crystal.gen.RetractableLegsCoreUnit", RetractableLegsCoreUnit.class, RetractableLegsCoreUnit::create);
    }
}
